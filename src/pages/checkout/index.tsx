					...
					<div className="auto-container">
						...
						<div className="checkout-form">
							...
							>
								{({
									...
									<form onSubmit={handleSubmit} ref={checkoutFormRef} className="needs-validation" noValidate>
						...
						<div className="payment-box">
							...
							<div className="lower-box">
								<a className="theme-btn" onClick={() => checkoutFormRef.current?.requestSubmit()}><span className="btn-title">Cotizar</span></a>
							</div>
						</div>
